...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative mx-auto flex max-w-fit flex-row items-center justify-center font-medium ${showBorder ? 'rounded-[1.25rem] py-1 px-2 backdrop-blur' : ''} ${className}`}
